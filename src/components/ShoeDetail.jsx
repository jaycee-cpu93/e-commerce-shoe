    ...
    <div className="flex flex-col lg:flex-row-reverse space-y-4 dark:text-white">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex space-x-6">
          ...
          <Select value={form.size} onChange={(size) => setForm({...form, size})}  title={"SIZES"} options={SIZES} />
        </div>
        {/* Shoe buttons and links */}
        <div className="space-x-10">
          <button onClick={()=>onClickAdd(shoe, form.qty, form.size)} className="btn-press-anim h-14 w-44 bg-black text-white hover:bg-gray-900 active:bg-gray-700 dark:bg-white dark:text-black">
            Add to bag
          </button>
          <a
            href="#"
